...
async function multipartUpload() {
    try {
        ...
        const result = await client.multipartUpload('exampledir/exampleobject.png', path.normalize('./imgs/ai.png'), {
            progress,
            // headers,
        ...
        const head = await client.head('exampledir/exampleobject.png');
